            ...
            try {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        boolean anadiLibro = AccesoLibro.anadirLibro(
                            isbn,
                            titulo,
                            escritor,
                            anyoPublicacion,
                    ...
                    case 4:
                        ...
                        ArrayList<Libro> consultarLibrosOrdenados = AccesoLibro.consultarLibrosOrdenados(
                            nombreEscritor
                        );
                    ...
                    case 6:
                        ...
                        ArrayList<Libro> consultarLibrosDevueltos = AccesoLibro.consultarLibrosDevueltos(
                            fechaDevolucion
                        );
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 3:
                        ...
                        boolean eliminarPrestamo = AccesoPrestamo.eliminarPrestamo(
                            codigoLibro,
                            codigoSocio,
                            fechaInicio
                        );
                    ...
                    case 5:
                        ...
                        ArrayList<Prestamo> consultarLosPrestamosNoDevueltos =
                            AccesoPrestamo.consultarLosPrestamosNoDevueltos();
            ...
            try {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        LinkedHashMap<Libro, Integer> consultarMenorLibroPrestado =
                            AccesoLibro.consultarMenorLibroPrestado();
                        ...
                        if (consultarMenorLibroPrestado.isEmpty()) {
                            ...
                            for (Libro libro : consultarMenorLibroPrestado.keySet()) {
                                System.out.println(
                                    "- " + libro + " | veces prestado: " + consultarMenorLibroPrestado.get(libro)
                                );
                            }
                        }
                    ...
                    case 2:
                        ...
                        LinkedHashMap<Socio, Integer> consultarSociosMayorPrestamos =
                            AccesoSocio.consultarSociosMayorPrestamos();
                        ...
                        if (consultarSociosMayorPrestamos.isEmpty()) {
                            ...
                            for (Socio socio : consultarSociosMayorPrestamos.keySet()) {
                                System.out.println(
                                    "- " + socio + " | total prestamos: " + consultarSociosMayorPrestamos.get(socio)
                                );
                            }
                        }
                        ...
                        if (consultarLibroPrestadoInferiorMedia.isEmpty()) {
                            ...
                            for (Libro libro : consultarLibroPrestadoInferiorMedia.keySet()) {
                                System.out.println(
                                    ...
                                    libro +
                                    " | veces prestado: " +
                                    consultarLibroPrestadoInferiorMedia.get(libro)
                                );
                            }
                        }
                        break;
                    case 4:
                        System.out.println("Consulta socio...");
                        LinkedHashMap<Socio, Integer> consultarSociosMayorMedia =
                            AccesoSocio.consultarSociosMayorMedia();
                        ...
                        if (consultarSociosMayorMedia.isEmpty()) {
                            ...
                            for (Socio socio : consultarSociosMayorMedia.keySet()) {
                                System.out.println(
                                    "- " + socio + " | total prestamos: " + consultarSociosMayorMedia.get(socio)
                                );
                            }
                        }
